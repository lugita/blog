<?php if (alia_cross_option('alia_show_header_logo', '', 1)): ?>
	<div class="header_square_logo">
		<?php if ( alia_option('alia_default_logo') ):
			...
			$srcset = '' ;
			$is_retina_logo = " no_retina_logo";
			if (esc_url(alia_option('alia_default_logo_retina'))) {
				$srcset = 'srcset="' . esc_url(alia_option('alia_default_logo')) . ' 1x, ' . esc_url(alia_option('alia_default_logo_retina')) . ' 2x"';
			...
			<a class="alia_logo default_logo <?php echo esc_attr($is_retina_logo); ?>" title="<?php bloginfo( 'name' ); ?>" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
				<img <?php echo esc_attr($logo_size_att); ?> src="<?php echo alia_option('alia_default_logo'); ?>" <?php echo $srcset; ?> class="site_logo img-responsive site_logo_image clearfix" alt="<?php bloginfo( 'name' ); ?>" />
			</a>
	...
	if (alia_cross_option('alia_show_header_social_icons', '', 1)):
		echo alia_social_icons_list('header_social_icons');
	endif;
endif;