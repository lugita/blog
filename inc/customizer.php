...
// Sanitize heading control
function alia_sanitize_heading( $input, $setting ) {
    return 0;
}

/* header partial render */
// content for both blog and single pages
function asalah_customize_partial_header_content() {
	ob_start();
		if (alia_cross_option('alia_show_top_header_area', '', 1)): ?>
		...
		</div><!-- end .header_nav_wrapper --><?php
...
function alia_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'performance_settings_section' , array(
	    'title'      => __('Performance Settings (BETA)','alia'),
	    'priority'   => 87,
	) );
	/* --------
	end define sections
	...
	$wp_customize->add_setting(
    	'alia_header_bg_title',
			array(
				'sanitize_callback' => 'alia_sanitize_heading',
			)
    );
    ...
    /* show gray header area in home page only */
    $wp_customize->add_setting(
        'alia_show_top_header_homepage_area',
        array(
        	'sanitize_callback' => 'absint',
            'default'     => 0,
        )
    ...
    $wp_customize->add_control('alia_show_top_header_homepage_area', array(
        'label'      => esc_attr__('Show Top Header Area In Homepage Only', 'alia'),
        'section'    => 'header_settings_section',
        'settings'   => 'alia_show_top_header_homepage_area',
        'type'       => 'checkbox'
    ));
    /* end show gray header area */
    ...
    $wp_customize->add_control('alia_show_header_logo', array(
        'label'      => esc_attr__('Show Logo in Site Header', 'alia'),
				'description' => __('You can upload/change the <a data-control="alia_default_logo" href="#" class="asalah-custom-refresh-partial">Logo Image</a>.', 'alia'),
        'section'    => 'header_settings_section',
    ...
    $wp_customize->add_control('alia_show_header_description', array(
        'label'      => esc_attr__('Show Description in Site Header', 'alia'),
				'description' => __('You can edit the <a data-control="alia_header_description" href="#" class="asalah-custom-refresh-partial">description</a>.', 'alia'),
        'section'    => 'header_settings_section',
    ...
    $wp_customize->add_control('alia_show_header_site_title', array(
        'label'      => esc_attr__('Show Site Title in Menu Area', 'alia'),
				'description' => __('You can edit the <a data-control="blogname" href="#" class="asalah-custom-refresh-partial">Site Title</a>.', 'alia'),
        'section'    => 'header_settings_section',
    ...
    $wp_customize->add_control('image_header_bar_logo', array(
        'label'      => esc_attr__('Show Image instead of text in Menu Area', 'alia'),
        'section'    => 'header_settings_section',
        'settings'   => 'image_header_bar_logo',
        'type'       => 'checkbox'
    ));

		$wp_customize->add_setting(
		   'alia_menu_default_logo',
		   array(
		       'default'     => '',
		       'sanitize_callback' => 'esc_url',
		   )
		...
		$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'alia_menu_default_logo', array(
		   'label'      => esc_attr__('Default Menu Logo', 'alia'),
		   'section'    => 'header_settings_section',
		   'settings'   => 'alia_menu_default_logo',
		)));

		$wp_customize->add_setting(
		   'alia_menu_retina_logo',
		   array(
		       'default'     => '',
		       'sanitize_callback' => 'esc_url',
		   )
		...
		$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'alia_menu_retina_logo', array(
		   'label'      => esc_attr__('Retina Menu Logo', 'alia'),
		   'section'    => 'header_settings_section',
		   'settings'   => 'alia_menu_retina_logo',
		)));
	...
	$wp_customize->add_control('asalah_custom_header_code', array(
		'label'      => __('Code to add before </head> - ex. Google Analytics', 'alia'),
	...
	/* add website field to comments form */
	$wp_customize->add_setting(
	    'alia_comment_website',
	    array(
	    	'sanitize_callback' => 'absint',
	        'default'     => 0,
	    )
	...
	$wp_customize->add_control('alia_comment_website', array(
	    'label'      => esc_attr__('Add website field to comments form', 'alia'),
	    'section'    => 'general_settings_section',
	    'settings'   => 'alia_comment_website',
	    'type'       => 'checkbox'
	));
	...
	$wp_customize->add_control( new Alia_Customizer_Heading_Text(
		...
		'alia_admin_settings',
		array(
			'label'	=> esc_attr__( 'Options related to Admin Side', 'alia' ),
			'section' => 'general_settings_section',
			'settings' => 'alia_admin_settings',
		)
	));
	...
	$wp_customize->add_control('alia_hide_changelog', array(
	    'label'      => esc_attr__('Hide Alia Changelog from Admin Bar', 'alia'),
	    'section'    => 'general_settings_section',
	    'settings'   => 'alia_hide_changelog',
	    'type'       => 'checkbox'
	));

	$wp_customize->add_setting(
	    'alia_disable_admin_style',
	    array(
	    	'sanitize_callback' => 'absint',
				'transport' => 'postMessage',
	        'default'     => 0,
	...
	$wp_customize->add_control('alia_disable_admin_style', array(
	    'label'      => esc_attr__('Disable Alia Style from Admin interface', 'alia'),
	    'section'    => 'general_settings_section',
	    'settings'   => 'alia_disable_admin_style',
	    'type'       => 'checkbox'
	));
	...
	$wp_customize->add_control('alia_show_views', array(
			'label'      => esc_attr__('Views', 'alia'),
			'section'    => 'general_settings_section',
			'settings'   => 'alia_show_views',
			'type'       => 'checkbox'
	));
	...
	$wp_customize->add_control('asalah_relation_posts', array(
	    'label'      => esc_attr__('Related Posts According to', 'alia'),
	    'section'    => 'post_settings_section',
	    'settings'   => 'asalah_relation_posts',
	    'type'       => 'select',
	    'choices'    => array(
				'category' => __('Categories', 'alia'),
				'tag' => __('Tags', 'alia'),
				'author' => __('Author', 'alia'),
	    ),
	));
	...
	if (function_exists('alia_create_stories')) {
		...
		$sticky_footer_options_array['blogposts_circle'] = esc_attr__('Show Blog Posts Circles', 'alia');
		$sticky_footer_options_array['custom_footer_content'] = esc_attr__('Show Custom Footer Content', 'alia');
	}
	...
	$wp_customize->add_setting(
	    'alia_sticky_footer_custom_content',
	    array(
	        'sanitize_callback' => 'alia_sanitize_minimal_decoration',
	        'default' => ''
	    )
	...
	$wp_customize->add_control('alia_sticky_footer_custom_content', array(
	    'label'      => esc_attr__('Footer Custom Content', 'alia'),
	    'description' => esc_attr__( 'Allowed HTML Tags: a, em, br, strong, img, i.', 'alia' ),
	    'section'    => 'footer_settings_section',
	    'settings'   => 'alia_sticky_footer_custom_content',
	    'type'       => 'textarea',
	));
	/* footer custom content */
  ...
  // );
	//
  // $wp_customize->add_control( 'alia_js_conditional_load', array(
	//       'label'      => __('Enable Conditional Javascript Loading (to be used with minifying/combining plugins)', 'alia'),
	//       'section'    => 'performance_settings_section',
	//       'settings'   => 'alia_js_conditional_load',
	// 			'type'       => 'checkbox'
	//   )
	// );
	...
	$wp_customize->add_control('alia_lazyload_iframe_banner', array(
	...
	/* Lazy loading images */
		...
		$wp_customize->add_control('alia_lazyload_image_banner', array(
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Alia_Customizer_Heading_Text extends WP_Customize_Control {
	    ...
	    public function render_content() {
	        ...
	        echo '<p class="description">' . wp_specialchars_decode($this->description) . '</p>';
	        echo '<hr />';
