					...
					<div class='story_single_row row'>
						...
						<div class="col5 alia_story_comments">
							...
							$output .= '<div class="story_view_info clearfix">';
								...
								$output .= '<span class="story_item_author_avatar"><a class="meta_author_avatar_url" href="'.esc_url( get_author_posts_url($author_id) ).'">'.alia_filter_lazyload_images(get_avatar($author_id, 40)).'</a></span>';
